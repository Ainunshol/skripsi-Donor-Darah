...
import com.donora.ainun.LocationAdapter
import com.donora.ainun.LocationProvider
...
class UnitDonorDarahActivity : AppCompatActivity() {
    ...
    private fun AStar(
        latCurrentLocation: Float,
        longCurrentLocation: Float,
        latLocation: Float,
        longLocation: Float
    ): Float {
        val dLat = latLocation - latCurrentLocation
        val dLong = longLocation - longCurrentLocation
